    ...
    <div>
        ...
        <table class="table table-sm">
            ...
            <tr v-for="(product, index) in products" :key="product.id">
                ...
                <td><img style="width:50px;height: 50px;border-radius: 10px" :src="product.product_image" alt="product image"></td>
                <td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button @click.prevent="hideModel()" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
    ...
    methods: {
        ...
        async addProduct(e) {
            ...
            try {
                ...
                formData.append('test','Tanbeer Hasan')
                console.log(formData,99)
        ...
        async updateProduct(e) {
            ...
            try {
                ...
                const response = await axios.post(`/api/admin/products/${this.selectedProduct.id}`, formData,{
                    headers: {
                        Authorization: `Bearer ${this.$store.state.token}`,
                    },
                });
